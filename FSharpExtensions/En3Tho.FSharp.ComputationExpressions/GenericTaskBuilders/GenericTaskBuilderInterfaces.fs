...
type IGenericTaskBuilderStateMachineDataInitializer<'TData, 'TState, 'TBuilderResult> =
    // static abstract MustBoxStateMachine: state: byref<'TState> -> bool
    //
    // static abstract InitializeBox<'TStateMachine, 'TData when 'TStateMachine :> IAsyncStateMachine and 'TStateMachine :> IResumableStateMachine<'TData>>
    //     : box: StateMachineBox<'TStateMachine, 'TData> * data: byref<'TData> * state: 'TState  -> 'TBuilderResult
