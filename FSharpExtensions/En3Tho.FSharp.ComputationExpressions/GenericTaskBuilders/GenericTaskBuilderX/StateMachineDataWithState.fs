...
type StateMachineDataWithState<'TMethodBuilder, 'TAwaiter, 'TTask, 'TState, 'TStateCheck, 'TResult, 'TBuilderResult
    ...
    interface IGenericTaskBuilderStateMachineDataResult<StateMachineDataWithState<'TMethodBuilder, 'TAwaiter, 'TTask, 'TState, 'TStateCheck, 'TResult, 'TBuilderResult>, 'TResult> with
