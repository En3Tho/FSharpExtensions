...
type StateMachineData<'TMethodBuilder, 'TTask, 'TResult
    ...
    interface IStateMachineData<StateMachineData<'TMethodBuilder, 'TTask, 'TResult>, 'TResult> with
...
type [<Struct>] DefaultStateMachineDataInitializer<'TMethodBuilder, 'TTask, 'TResult
    ...
    interface IStateMachineDataInitializer<StateMachineData<'TMethodBuilder, 'TTask, 'TResult>, unit, 'TTask> with
...
type StateMachineRefDataBase<'TMethodBuilder, 'TTask, 'TResult
    ...
    interface IStateMachineData<StateMachineRefDataBase<'TMethodBuilder, 'TTask, 'TResult>, 'TResult> with
