...
type UnitStateMachineData<'TMethodBuilder, 'TTask
    ...
    interface IGenericTaskStateMachineData<UnitStateMachineData<'TMethodBuilder, 'TTask>, unit> with
...
type [<Struct>] DefaultUnitStateMachineDataInitializer<'TMethodBuilder, 'TTask
    ...
    interface IGenericTaskStateMachineDataInitializer<UnitStateMachineData<'TMethodBuilder, 'TTask>, unit, 'TTask> with
