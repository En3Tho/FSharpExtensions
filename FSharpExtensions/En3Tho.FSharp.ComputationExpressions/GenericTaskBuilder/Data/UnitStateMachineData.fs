...
type UnitStateMachineData<'TMethodBuilder, 'TTask
    ...
    interface IGenericTaskStateMachineData<UnitStateMachineData<'TMethodBuilder, 'TTask>> with
...
type [<Struct>] DefaultUnitStateMachineDataInitializer<'TMethodBuilder, 'TTask
    ...
    interface IGenericTaskBuilderStateMachineDataInitializer<UnitStateMachineData<'TMethodBuilder, 'TTask>, unit, 'TTask> with
