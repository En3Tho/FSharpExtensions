...
module PipeAndCompositionOperatorEx =
    ...
    module Pipe2 =
        ...
        type T = T with
            ...
            static member inline ($) (T, invokable: 'a -> 'b -> 'c) = fun (value1, value2) -> invokable value1 value2
    ...
    module Pipe3 =
        ...
        type T = T with
            ...
            static member inline ($) (T, invokable: 'a -> 'b -> 'c -> 'd) = fun (value1, value2, value3) -> invokable value1 value2 value3
