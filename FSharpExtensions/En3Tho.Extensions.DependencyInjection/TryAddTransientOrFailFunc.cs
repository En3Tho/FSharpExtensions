...
{
    public static IServiceCollection TryAddTransientOrFailFunc<TService, TDependency1>(
        this IServiceCollection collection,
        Func<TDependency1, TService> factory)
        where TService : class
        where TDependency1 : notnull
    {
        return collection.TryAddTransientOrFail(
            serviceProvider => factory(
                serviceProvider.GetRequiredService<TDependency1>()));
    }

    public static IServiceCollection TryAddTransientOrFailFunc<TService, TDependency1, TDependency2>(
        this IServiceCollection collection,
    ...
    public static IServiceCollection TryAddTransientOrFailFunc<TService, TDependency1, TDependency2, TDependency3>(
        this IServiceCollection collection,
