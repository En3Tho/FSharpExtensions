...
public static partial class IServiceCollectionExtensions
{
    ...
    {
        return collection.TryAddScopedOrFail(
            serviceProvider => factory(
                serviceProvider.GetRequiredService<TDependency1>()));
    }

    public static IServiceCollection TryAddScopedOrFailFunc<TService, TDependency1, TDependency2>(
    ...
    public static IServiceCollection TryAddScopedOrFailFunc<TService, TDependency1, TDependency2, TDependency3>(
        this IServiceCollection collection,
