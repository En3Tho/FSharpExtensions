...
type Benchmark() =
    ...
    member _.BytesToBase64VectorLookup1(source: ReadOnlySpan<byte>, destination: Span<char>) =
        ...
        let lookup0_31 = v256.Create(0x48_47_46_45_44_43_42_41UL, 0x50_4F_4E_4D_4C_4B_4A_49UL, 0x58_57_56_55_54_53_52_51UL, 0x66_65_64_63_62_61_5A_59UL).u8
        let lookup32_63 = v256.Create(0x6E_6D_6C_6B_6A_69_68_67UL, 0x76_75_74_73_72_71_70_6FUL, 0x33_32_31_30_7A_79_78_77UL, 0x2F_2B_39_38_37_36_35_34UL).u8
        ...
        while i + 2 < valuesU64.Length do
            ...
            let vec = v256.Create(v1, v2, v3, 0UL)

            // [ 00000000_66666666_55555555_44444444_00000000_33333333_22222222_11111111 ]
            let shuffled = v256.Shuffle(vec.u8, v256.Create(0xF0_05_04_03_F0_02_01_00UL, 0xF0_0B_0A_09_F0_08_07_06UL, 0xF0_11_10_0F_F0_0E_0D_0CUL, 0xF0_17_16_15_F0_14_13_12UL).u8).u32

            // [ 00666666_00665555_00555544_00444444_00333333_00332222_00222211_00111111 ]
            let vec6Bits =
                (shuffled &&& v256.Create(0x3Fu))
                ||| ((shuffled &&& v256.Create(0xFC0u)) <<< 2)
                ||| ((shuffled &&& v256.Create(0x3F000u)) <<< 4)
                ||| ((shuffled &&& v256.Create(0xFC0000u)) <<< 6)

            let mask32_63 = v256.GreaterThan(vec6Bits.u8, v256.Create(31uy))
            let mask0_31 = v256.Equals(mask32_63, v256.Zero)

            let byteChars0_31 = v256.Shuffle(lookup0_31, vec6Bits.u8 &&& mask0_31)
            let byteChars32_63 = v256.Shuffle(lookup32_63, vec6Bits.u8 &&& v256.Create(0x1Fuy) &&& mask32_63)
            let byteChars = (byteChars0_31 &&& mask0_31) ||| (byteChars32_63 &&& mask32_63)

            let chars1 = v256.Shuffle(byteChars, v256.Create(0xF0_03_F0_02_F0_01_F0_00UL, 0xF0_07_F0_06_F0_05_F0_04UL, 0xF0_0B_F0_0A_F0_09_F0_08UL, 0xF0_0F_F0_0E_F0_0D_F0_0CUL).u8)
            let chars2 = v256.Shuffle(byteChars, v256.Create(0xF0_13_F0_12_F0_11_F0_10UL, 0xF0_17_F0_16_F0_15_F0_14UL, 0xF0_1B_F0_1A_F0_19_F0_18UL, 0xF0_1F_F0_1E_F0_1D_F0_1CUL).u8)
